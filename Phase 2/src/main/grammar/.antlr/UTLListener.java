...
public interface UTLListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link UTLParser#globalVarDeclaration}.
	 * @param ctx the parse tree
	 */
	void enterGlobalVarDeclaration(UTLParser.GlobalVarDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link UTLParser#globalVarDeclaration}.
	 * @param ctx the parse tree
	 */
	void exitGlobalVarDeclaration(UTLParser.GlobalVarDeclarationContext ctx);
	/**
